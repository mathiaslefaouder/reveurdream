...
//HDR needs to be disable for transparent backgrounds
    camera.flyTo({
        destination: Cartesian3.fromDegrees(2.3491, 48.8579, 150000.0 * 20)
    });
...
document.getElementById('filters-button').addEventListener('click', resetFilter)
